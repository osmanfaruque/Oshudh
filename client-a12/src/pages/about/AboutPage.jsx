        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-8 sm:mb-10">
              <h2 className="heading-secondary text-blue-600 mb-4 sm:mb-6">
                Health at Your Door 🏥
              </h2>
            ...
            <div className="text-center mt-8 sm:mt-10 lg:mt-12">
              <Link to="/shop" className="medical-btn-primary text-button px-6 sm:px-8 lg:px-10 py-3 sm:py-4 inline-block">
                Start Shopping 🛒
              </Link>
            </div>
          </div>
